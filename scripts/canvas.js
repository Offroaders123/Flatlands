...
const offsetY = () => Math.round((canvas.offsetHeight + (version.offsetHeight ? (version.offsetHeight + parseInt(window.getComputedStyle(hud).getPropertyValue("gap"))) : 0) + coordinates.offsetHeight - hotbar.offsetHeight - parseInt(window.getComputedStyle(hud).getPropertyValue("padding-bottom"))) / scaling / 2);
/*
